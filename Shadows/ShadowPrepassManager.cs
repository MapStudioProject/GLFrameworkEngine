...
namespace GLFrameworkEngine
{
    public class ShadowPrepassManager
    {
          ...
          GLTexture shadowMap, GLTexture normalsTexture, GLTexture depthTexture, GLTexture2D output)
        {
            ...
            //Todo the wrap params are somehow being reset so update it here
            shadowMap.MagFilter = TextureMagFilter.Linear;
            shadowMap.MinFilter = TextureMinFilter.Linear;
            shadowMap.WrapS = TextureWrapMode.ClampToBorder;
            shadowMap.WrapT = TextureWrapMode.ClampToBorder;
            shadowMap.UpdateParameters();

...
namespace GLFrameworkEngine
{
    public class RenderTools
    {
        ...
        public static GLTexture blackTex { get; private set; }
        public static GLTexture whiteTex { get; private set; }
        ...
        public static void Init()
        {
            ...
            defaultTex.WrapT = TextureWrapMode.Repeat;
            defaultTex.UpdateParameters();
            defaultTex.Unbind();

            uvTestPattern.Bind();
            uvTestPattern.WrapS = TextureWrapMode.Repeat;
            uvTestPattern.WrapT = TextureWrapMode.Repeat;
            uvTestPattern.UpdateParameters();
            uvTestPattern.Unbind();
        }
